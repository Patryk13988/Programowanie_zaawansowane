...
#Test Akceptacyjny
class Test_caly(unittest.TestCase):
    def test_caly(self):
        main()
...
class FunctionTest(unittest.TestCase):
    def test_ogrzewanie_wołowina(self):
        result = BeefSandwich().heating_time
        self.assertEqual(result, 12)

    def test_ogrzewanie_kurczak(self):
        result = ChickenSandwich().heating_time
        self.assertEqual(result, 10)

    def test_ogrzewanie_tradycyjna(self):
        result = TraditionalSandwich().heating_time
        self.assertEqual(result, 8)

    def test_ogrzewanie_szynka(self):
        result = HamSandwich().heating_time
        self.assertEqual(result, 6)

    def test_ogrzewanie_pieczerki(self):
        result = MushroomSandwich().heating_time
        self.assertEqual(result, 12)